                ...
                <div className='flex flex-col lg:flex-row bg-white shadow-xl rounded-lg overflow-hidden h-screen w-full'>
                    ...
                    <div className='w-full lg:w-1/2 bg-gray-50 p-8 flex flex-col justify-center border-t lg:border-t-0 lg:border-1 border-gray-200'>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-4'>
                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder='Enter your email ID' className='w-full border border-gray-300 p-3 rounded'required />

                            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder='Enter Your Password' className='w-full border border-gray-300 p-3 rounded'required />
